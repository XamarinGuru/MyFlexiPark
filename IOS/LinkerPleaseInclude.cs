...
namespace FlexyPark.UI.Touch
{
	...
	public class LinkerPleaseInclude
	{
        ...
        public void Include (UINavigationItem item)
        {
		...
		public void Include(UIDatePicker date)
		{
			...
			date.ValueChanged += (sender, args) => { date.Date = DateTime.MaxValue.DateTimeToNSDate(); };
		}
        ...
        public void Include(UITabBar tabbar)
        {
            tabbar.UserInteractionEnabled = !tabbar.UserInteractionEnabled;
        }
