...
{
	public interface IRentFragmentView
	{
		/// <summary>
	...
	public class RentFragmentViewModel : BaseViewModel
	{
		#region Constructors

		public RentFragmentViewModel(IApiService apiService, ICacheService cacheService) : base(apiService, cacheService)
		{
		}
