...
namespace FlexyPark.UI.Droid.Controls
{
    public class TabPageIndicator : HorizontalScrollView, PageIndicator
	{
		...
		public TabPageIndicator (Context context, IAttributeSet attrs) : base(context, attrs)
		{
            ...
            mTabLayout.SetBackgroundColor(Resources.GetColor(Resource.Color.bg_lv));
...
//        }
        ...
        [Register("FlexyPark.UI.Droid.Controls.TabPageIndicator_TabView")]
		public class TabView : LinearLayout
		{
			...
			public void Init (TabPageIndicator parent, string text, int index)
			{
				mParent = parent;
				mIndex = index;
			    string str = text.Substring(0, 1).ToUpper() + text.Substring(1).ToLower();
